...
export default function Register() {
  ...
  return (
    <>
      <NextSeo
        title="Register - Reiki Healing"
        description="Sign up for our Reiki Healing webinar or programs."
      />
      <main className="bg-gradient-to-br from-[#F8F3FF] to-[#EAE2F8] min-h-screen py-0">
