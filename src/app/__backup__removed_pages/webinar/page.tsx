...
export default function Webinar() {
  ...
  return (
    <>
      <NextSeo
        title="Webinar Details - Reiki Healing"
        description="Discover our upcoming Reiki Healing webinar and reserve your spot."
      />
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            >
              <Link
                href="/register"
                className="bg-[#FF6B6B] hover:bg-[#FF8585] text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-[#DA70D6]/50 w-full sm:w-auto"
              >
